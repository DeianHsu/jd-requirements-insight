...
| P0-8 样本扩展（8 → 12 → 15 JD） | 先完成 JD 9～12 抽取/归并/报告，再处理 JD 13～15；逐批测量成本、稳定性与人工裁决量 | 进行中（8 JD、12 JD 均已关闭；15 JD extraction、acceptance、增量审核与 frozen-base candidate 已完成；candidate=329 canonical / 409 mappings，等待外部 Review；15 为 MVP 固定终点） |
...
3. frozen-base 离线 apply 已直接继承正式 12 JD final result（IDs 1～300、
   ...
   `17d087e8…172c2`，冻结分区零差异。下一步等待外部 Review；order transformation
   hard gate=1 仍是 finalize 前的独立 blocker；
