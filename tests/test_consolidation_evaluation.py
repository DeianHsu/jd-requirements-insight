...
def test_missing_relation_reduces_relation_accuracy() -> None:
    """验证期望关系未被实际覆盖时关系准确率下降。"""
    cases = make_cases()
    actual = make_actual(
        {1: "能力甲使用经验", 2: "能力甲使用经验", 3: "能力乙"},
        relations=[],
