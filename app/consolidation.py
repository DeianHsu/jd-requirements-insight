...
CONSOLIDATION_PROMPT_VERSION = "4.2"
...
2. 正例："能力甲应用开发相关知识"与"能力甲应用开发技术原理"是同一条件；"熟悉能力甲"与"掌握能力甲"是同一条件（熟练度差异不改变条件身份）；"使用能力甲的经验"与"具备能力甲使用经验"是同一条件；"能力乙"与"能力乙技术"若证据指向同一技能也是同一条件。
3. 反例："能力甲开发经验"与"能力甲使用经验"若证据分别指向开发岗位经验与工具使用经验，是不同条件；"能力甲框架"与"能力甲"若前者特指框架本身而后者是泛指技能，是不同条件。
